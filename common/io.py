...
JET_DTYPE = np.dtype([
    ...
    ("phi",                                 np.float32),
    ("mass",                                np.float32),
    ("jets_regression_a_mass_preds",        np.float32), # for our specific regression output later, after initial write this is all 0
    ...
    ("jets_atlas_regression_a_mass_preds",  np.float32),  # for atlas regression output later, after initial write this is all 0
